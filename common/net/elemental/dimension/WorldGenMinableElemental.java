...
public class WorldGenMinableElemental extends WorldGenerator
{
	...
	public WorldGenMinableElemental(int par1, int par2)
	{
		...
		this(par1, par2, Blocks.elementalStoneBlock.blockID);
	}

	public WorldGenMinableElemental(int par1, int par2, int par3)
	{
	...
	public WorldGenMinableElemental(int id, int meta, int number, int target)
	{

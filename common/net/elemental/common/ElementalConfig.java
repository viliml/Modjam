...
public class ElementalConfig 
{
	...
	public static void initConfigs()
	{
		...
		Blocks.ELEMENTAL_SINGLE_SLAB_BLOCK_ID =
				CONFIG.getBlock(Blocks.ELEMENTAL_SINGLE_SLAB_NAME,
						Blocks.ELEMENTAL_SINGLE_SLAB_BLOCK_ID)
						.getInt(Blocks.ELEMENTAL_SINGLE_SLAB_BLOCK_ID);
		Blocks.ELEMENTAL_DOUBLE_SLAB_BLOCK_ID =
				CONFIG.getBlock(Blocks.ELEMENTAL_DOUBLE_SLAB_NAME,
						Blocks.ELEMENTAL_DOUBLE_SLAB_BLOCK_ID)
						.getInt(Blocks.ELEMENTAL_DOUBLE_SLAB_BLOCK_ID);
		...
		Items.WING_ITEM_ID =
				CONFIG.getItem(Items.WING_NAME,
						Items.WING_ITEM_ID)
						.getInt(Items.WING_ITEM_ID);
		Items.STAFF_ITEM_ID =
				CONFIG.getItem(Items.STAFF_NAME,
						Items.STAFF_ITEM_ID)
						.getInt(Items.STAFF_ITEM_ID);
